...
use Ampeco\OmnipayMidtrans\CommonParameters;

abstract class AbstractRequest extends \Omnipay\Common\Message\AbstractRequest
{
    use CommonParameters;

    const ENDPOINT_TESTING = 'https://api.sandbox.midtrans.com/v2';
    const ENDPOINT_PRODUCTION = 'https://api.midtrans.com/v2';
